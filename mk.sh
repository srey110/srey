...
PROGRAMNAME="srey"
MAINFILE="main.c"
Dir="lib lib/base lib/utils lib/containers lib/crypt lib/event lib/protocol lib/protocol/mongo lib/protocol/mqtt lib/protocol/mysql lib/protocol/pgsql lib/srey lib/thread"
if [ $LUA -eq 1 ]
then
