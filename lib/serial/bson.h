...
#define BSON_FREE(bson)  binary_free(&((bson)->doc))
...
typedef enum bson_type {
    ...
    BSON_MAXKEY = 0x7F,//Max key             signed_byte(127) e_name
    BSON_MINKEY = 0xFF,//Min key             signed_byte(-1) e_name
} bson_type;
...
/// <summary>
/// 追加 UTF-8 字符串类型字段（二进制安全，允许 val 含 NUL）
/// </summary>
/// <param name="bson">bson_ctx</param>
/// <param name="key">字段名</param>
...
/// <param name="bson">bson_ctx</param>
/// <param name="key">字段名</param>
/// <param name="jscode">代码字节</param>
/// <param name="lens">代码字节长度</param>
